...
- **안정성 (40점):** 부채비율(20점), 영업활동 현금흐름(20점)
- **수익성 (30점):** ROE(15점), 영업이익률(15점)
- **가치 (20점):** PER(10점), PBR(10점)
- **미래 투자 (10점):** 매출액 대비 R&D 및 CapEx 비중(10점)
...
- **고금리 상황에서 부채 비율이 높은 기업 (-20점):** 금리가 높을 경우 부채가 많은 기업은 이자 비용이 상승합니다. 이 경우 부도 확률이 급격히 올라가므로 금리가 높은(4% 이상) 상황에서 부채가 많은(부채 비율 200% 이상) 기업은 감점(-15점)하고 빚이 더 늘어나는 경우(설비 투자, R&D 등) 추가로 감점(-5점)합니다.
