...
**"위험한 기업을 회피하고, 지속 가능한 투자를 돕는 백엔드 시스템"** 재무제표 데이터와 거시 경제 지표를 결합하여 기업의 투자 적합성을 **점수(Score)**와 **등급(Grade)**으로 산출합니다.
<br/>
...
<img src="https://img.shields.io/badge/Architecture-MSA_Ready-purple" />
</div>
...
| 📊 재무 건전성 평가 | 🌏 거시 경제 대시보드 | ⚠️ 동적 페널티 시스템 |
| :---: | :---: | :---: |
| 안정성, 수익성, 가치, 투자<br>4대 지표 기반 스코어링 | 미 연준(Fed) API 연동<br>금리, 실업률 실시간 추적 | 경기 침체 시그널 감지 시<br>위험 기업 점수 자동 차감 |

# 실행 방법
- docker-compose up -d 후 애플리케이션 실행