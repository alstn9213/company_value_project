...
import com.back.domain.StockPriceHistory;
import com.back.domain.repository.CompanyRepository;
import com.back.domain.repository.StockPriceHistoryRepository;
...
public class StockService {
    ...
    public List<StockHistoryDto> getStockHistory(String ticker) {
        ...
        return histories.stream()
                .map(h -> new StockHistoryDto(h.getRecordedDate(), h.getClosePrice()))
                .toList();
    }
