...
* **과락 제도:** 자본잠식이나 과도한 부채 비율 시 즉시 F등급 부여.
...
## 4. 향후 개발 계획
1. **Frontend 구현:** React 프로젝트 세팅 및 라우팅 구성, API 연동.
2. **API 확장:** 검색, 랭킹 조회, 관심 종목 관리 등 클라이언트용 API 엔드포인트 추가 개발.
3. **사용자 경험 개선:** 로딩 상태 처리 및 에러 핸들링, 반응형 UI 적용.