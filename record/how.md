...
- 기업들의 재무 정보들을 활용해서 그 기업이 주식 투자하기에 적절한지 판단하는데 도움을 주는 웹사이트 제작을 목표로 한다.

- 총점은 100점으로 해서 기업마다 점수를 매긴다. 점수가 높을수록 투자하기에 매력적인 기업이라는 의미이다.

- 웹사이트의 목적은 어디까지나 재무상태가 부실한 기업을 피하고 재무상태에 비해 상대적으로 주가가 저평가된 기업을 판단하는 데 있기때문에, 기업에 대한 평가 기준을 보수적으로 잡는다.
